            ...
            $(function() {
                ...
                function requisicao_add_notas($url, $local, $acao = 2, $valor, $cor) {
                    $.ajax({
                        ...
                        requisicao_notas($url, '/theme/colors/cursos_menu_lateral/notas/get_notas.php', 1, 0, "Falha ao adicionar anotação!");
                    }).done(function(data) {
                        requisicao_notas($url, '/theme/colors/cursos_menu_lateral/notas/get_notas.php', 1, 1, "Nota adicionada com sucesso!");
                    })
                }
                //Adicionar uma nota
                $(document).on('click', "#add-note", function() {
                    if ($("#nota").val() != '') {
                        ...
                        requisicao_add_notas($url, '/theme/colors/cursos_menu_lateral/notas/add_notas.php', 2, nota, cor);
                    }
                });
                ...
                function requisicao_del_notas($url, $local, $acao = 3, $valor) {
                    $.ajax({
                        ...
                        requisicao_notas($url, '/theme/colors/cursos_menu_lateral/notas/get_notas.php', 1, 0, "Falha ao deletar anotação!");
                    }).done(function(data) {
                        requisicao_notas($url, '/theme/colors/cursos_menu_lateral/notas/get_notas.php', 1, 1, "Nota deletada com sucesso!");
                    })
                }
                //Remover uma nota
                function NotaDeleteClick() {
                    ...
                    $(document).on('click', "#confirm_delete", function() {
                        requisicao_del_notas($url, '/theme/colors/cursos_menu_lateral/notas/del_notas.php', 3, val);
                    });
                }
                ...
                function requisicao_update_notas($url, $local, $acao = 4, $valor, $id, $cor) {
                    $.ajax({
                        ...
                        requisicao_notas($url, '/theme/colors/cursos_menu_lateral/notas/get_notas.php', 1, 0, "Falha ao atualizar a anotação!");
                    }).done(function(data) {
                        requisicao_notas($url, '/theme/colors/cursos_menu_lateral/notas/get_notas.php', 1, 1, "Nota atualizada com sucesso!");
                    })
                }
                //Editar uma nota
                function NotaSalvarEdit() {
                    ...
                    if ($(".nota-editar").val() != '') {
                        ...
                        requisicao_update_notas($url, '/theme/colors/cursos_menu_lateral/notas/update_notas.php', 4, valor_nota, val, cor);
                    }
                }
