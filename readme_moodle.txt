...
* remove folder theme/colors/scss/bootstrap
* copy the scss files from ~/bootstrap/scss to theme/colors/scss/bootstrap
...
* comment out this line in theme/colors/scss/_print.scss
    @page {
...
* remove folder theme/colors/amd/src/bootstrap
* copy the js files from ~/bootstrap/js/src to theme/colors/amd/src/bootstrap (including the subfolder)
* copy index.js from ~/bootstrap/js to theme/colors/amd/src
* edit theme/colors/amd/src/index.js and update import path (src -> bootstrap)
...
* in folder theme/colors run "grunt amd" to compile the bootstrap JS
* in folder theme/colors run "grunt css" to compile scss
